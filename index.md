...
Welcome to my e-Portfolio. My name is Alex Bevz and I am currently in my last term at Southern New Hampshire University. I am also employed full time at a healthcare company where I am a Supervisor in a Healthcare Analytics team. In this job, I collaborate in a team environment by working closely with my team members, as well as other internal and external stakeholders. The healthcare sector is a highly regulated field which calls for collaboration across multidisciplinary areas to ensure that the work is performed correctly. As part of my job, I have to work both with my IT and Business partners to ensure that all necessary components of my job responsibilities are performed to the highest acceptable standards. I work with my IT partners on major SDLC projects whenever a major system is being introduced or updated. I work with other business sectors in my company, such as Compliance, to ensure that all business requirements are completed according to the strict government agreements that we must abide by. 

Finally, I collaborate with my team on a daily basis to ensure that our team is well supported and to communicate any new requirements that are expected of us. Database and security management are very important in our line of work since we work with protected health information of our members. To ensure maximum protection of this data we have to follow our IT Security policies, which include high-end encryption, strict user permissions monitoring, user log history monitoring, defense in depth strategies, the minimum necessary rules when handling sensitive information, and we undergo constant training on protecting and safeguarding sensitive information to minimize the risk of data breaches. 

The computer science program at SNHU has taught me so much over the last few years and has truly allowed me to hone my computer science skills and sharpen my knowledge. In this capstone course, I developed this ePortfolio which showcases these skills. Specifically, I made enhancements to a project that I had created for a previous course at SNHU, and these enhancements required me to apply my knowledge and skills in three major areas: computer science and software engineering, algorithms and data structures, and databases. This project was a mobile application which allows users to register, login, set a goal weight, and track their daily weights. The users can also choose to receive SMS notifications when they reach their goal weight.

For the first enhancement, I showcased my computer science and software design skills by creating a more professional UI for my application. This included resolving some issues that I previously had with one of the displays. In this enhancement, I showed that I can create visually appealing and professional applications that change dynamically based on a user’s actions. For the second enhancement, I modified the algorithm used to check if a user has reached their goal weight. This function did not work previously, but I also enhanced it by ensuring that it would check not only the last added daily weight, but also edited daily weights. This also required adding more dimension to the data structure for user objects. For the third enhancement, I added some security to the SQLite database to protect usernames and passwords. I also created an administrator role to manage the database. Together, these enhancements show that I am able to use logic and dedication, along with my computer science skills, to create a project that meets user requirements, is functional and efficient, and is professionally put together. 
